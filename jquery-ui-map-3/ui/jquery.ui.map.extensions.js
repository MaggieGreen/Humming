...
( function($) {
	...
	$.extend($.ui.gmap.prototype, {
		...
		/*loadPanoramio: function(panoramioLayerOptions) {
			...
			this.get('overlays').PanoramioLayer.setOptions(jQuery.extend({'mapOne': this.get('mapOne') }, panoramioLayerOptions));
		},*/
		 ...
		 */
		/*placesSearch: function(placeSearchRequest, callback) {
			this.get('services > PlacesService', new google.maps.places.PlacesService(this.get('mapOne'))).search(placeSearchRequest, callback);
		},*/
		...
		/*placesDetails: function(placeDetailsRequest, callback) {
			this.get('services > PlacesService', new google.maps.places.PlacesService(this.get('mapOne'))).getDetails(placeDetailsRequest, callback);
		},*/
